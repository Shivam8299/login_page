...
const Header: FC = () => {
  return (
    <div className="w-full rounded-lg bg-[linear-gradient(127deg,rgb(14,28,41)_-68%,rgb(50,61,104)_100%)] text-white px-6 py-3 2xl:py-5 flex justify-between items-center shadow-md">
      {/* Left Side */}
      <div>
