...
export default function Sidebar() {
  return (
    <aside className="w-65 bg-white border-r border-gray-200 flex flex-col justify-between ">
      <div>
      ...
      <div className="mb-4 space-y-3 pl-4 pr-8">
        <div className="px-2 py-2 bg-gray-50 rounded-lg border border-gray-200 flex items-center gap-2 cursor-pointer hover:bg-gray-100">
        ...
        <div className="px-2 py-2 bg-gray-50 rounded-lg border border-gray-200 flex items-center gap-2 cursor-pointer hover:bg-gray-100">
          <div className="w-8 h-8 rounded-lg bg-gray-800 text-white flex items-center justify-center font-medium">
            QB
          </div>
          <div>
